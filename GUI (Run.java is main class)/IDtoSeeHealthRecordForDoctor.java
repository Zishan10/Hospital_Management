...
public class IDtoSeeHealthRecordForDoctor extends JFrame implements ActionListener
{
    ...
    public IDtoSeeHealthRecordForDoctor()
	
	{
		...
		b1 = new PosButton("Logout",  new Color(156, 232, 55), new Color(11, 190, 77));
		b1.setForeground(Color.black);
		b1.setFont(new Font("Calibri",Font.PLAIN,25));
		b1.setBounds(1150,720,150,50);
		...
		b3 = new PosButton("See Patient's Health Record", new Color(156, 232, 55), new Color(11, 190, 77));
		b3.setForeground(Color.black);
		b3.setFont(new Font("Calibri",Font.PLAIN,25));
		b3.setBounds(750,720,350,50);
	...
	public void actionPerformed(ActionEvent ae)
		{
			...
			{  
			   ...
			   DoctorComment dc = new DoctorComment(id);
		      this.setVisible(false);
			  dc.setVisible(true);
			}
}
