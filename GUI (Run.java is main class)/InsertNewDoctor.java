...
public class InsertNewDoctor extends JFrame implements ActionListener
{
    ...
    InsertNewDoctor()
    {
		...
		ImageIcon image = new ImageIcon("InsertNewDoctor.png");
		l1 = new JLabel(image);
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
	    {
		    DoctorID m = new DoctorID(t1.getText(),t3.getText());		
		    if(r1.isSelected())
		    {
				selected = "Male";
			}
			...
			try {
	        fw = new FileWriter("DoctorPass.txt", true);
			...
			pw.println("Degree : "+t5.getText());
			pw.println("Speciality : "+t6.getText());
