...
public class PatientIdForHelthRecord extends JFrame implements ActionListener
{
    ...
    PatientIdForHelthRecord()
    {
		...
		ImageIcon image = new ImageIcon("AdminLogin.png");
		l1 = new JLabel(image);
		...
		b1 = new PosButton("Next", new Color(156, 232, 55), new Color(11, 190, 77));
		   ...
		   if(ae.getSource()==b1)
			{
					...
					String a = t1.getText();
					EnterHealthRecords Eh = new EnterHealthRecords(a);
