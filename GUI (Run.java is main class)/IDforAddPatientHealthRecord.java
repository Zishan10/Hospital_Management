...
public class IDforAddPatientHealthRecord extends JFrame implements ActionListener
{
    ...
    public IDforAddPatientHealthRecord()
	
	{
		...
		b3 = new PosButton("Add Patient's Health Record", new Color(156, 232, 55), new Color(11, 190, 77));
	...
	public void actionPerformed(ActionEvent ae)
		{
			...
			{  
			   ...
			   EnterHealthRecords ehr = new EnterHealthRecords(id);
		      this.setVisible(false);
			  ehr.setVisible(true);
			}
}
